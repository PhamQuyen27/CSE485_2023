<?php
    ...
    // sửa
        ...
        $stmt = $conn->prepare("UPDATE baiviet set tieude =:tieude, ten_bhat =:t_bhat, ma_tloai =:theloai, tomtat =:tomtat, noidung =:noidung, ma_tgia =:tgia WHERE baiviet.ma_bviet = :id"); 
