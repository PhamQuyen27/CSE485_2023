...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 25, 2023 lúc 12:32 PM
...
ALTER TABLE `baiviet`
  ...
  ADD KEY `Fk_ma_tloai` (`ma_tloai`),
  ADD KEY `Fk_ma_tgia` (`ma_tgia`);
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `Fk_ma_tgia` FOREIGN KEY (`ma_tgia`) REFERENCES `tacgia` (`ma_tgia`),
  ADD CONSTRAINT `Fk_ma_tloai` FOREIGN KEY (`ma_tloai`) REFERENCES `theloai` (`ma_tloai`);
COMMIT;
